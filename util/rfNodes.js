...
export const rfStackMain = [
    { id: 'constraints', data: { label: '<<constraints>>' }, position: { x: 0, y: 0 }, style: { backgroundColor: 'yellow', width: 220, height: 300 }, },
    ...
    { id: 'ensures', data: { label: '<<ensures>>' }, position: { x: 10, y: 200 }, parentNode: 'constraints', extent: 'parent', style: { backgroundColor: 'yellow', width: 200, height: 100 }, },
...
export const rfCreateStack = [
    ...
    { id: 'result-var', type: 'objectNode', data: { label: 'stack' }, position: { x: 20, y: 50 }, parentNode: 'result', extent: 'parent', style: { backgroundColor: '', }, },
];
...
export const rfCreateNode = [
    ...
    { id: 'nptr', type: 'circleNode', data: { label: '⏊' }, position: { x: 5, y: 5 }, parentNode: 'nullpointer', extent: 'parent', },
    { id: 'result', data: { label: 'result' }, position: { x: 500, y: 0 }, style: { backgroundColor: '#dcb2dc', width: 200, height: 100 }, },
    { id: 'result-var', type: 'objectNode', data: { label: 'node' }, position: { x: 20, y: 50 }, parentNode: 'result', extent: 'parent', style: { backgroundColor: '', }, },
];
...
export const rfStackPop = [
    ...
    { id: 'node0', type: 'output', data: { label: '?n:node' }, position: { x: 250, y: 500 }, className: 'light', style: { backgroundColor: 'rgba(124, 252, 0, 0.2)', width: 200, height: 100 }, },
