...
export const rfStackMain = [
    { id: 'constraints', type: 'objectNode', data: { label: '<<constraints>>', backgroundColor: 'yellow',borderStyle : '1px solid black'  }, position: { x: 0, y: 0 }, style: { backgroundColor: 'yellow', width: 220, height: 300, border: '1px solid black', borderRadius: '5px' }, },
    { id: 'requires', type: 'objectNode', data: { label: '<<requires>>', backgroundColor: 'yellow',borderStyle : '1px solid black' }, position: { x: 10, y: 50 }, parentNode: 'constraints', extent: 'parent', style: { backgroundColor: 'yellow', width: 200, height: 100, border: '1px solid black', borderRadius: '5px' }, },
    ...
    { id: 'ensures', type: 'objectNode', data: { label: '<<ensures>>', backgroundColor: 'yellow',borderStyle : '1px solid black' }, position: { x: 10, y: 175 }, parentNode: 'constraints', extent: 'parent', style: { backgroundColor: 'yellow', width: 200, height: 100, border: '1px solid black', borderRadius: '5px' }, },
...
export const rfStackPop = [
    ...
    { id: 'constraints', type: 'objectNode', data: { label: '<<constraints>>' , backgroundColor: 'yellow',borderStyle : '1px solid black'}, position: { x: 500, y: 250 }, style: { backgroundColor: 'yellow', width: 220, height: 200, border: '1px solid black', borderRadius: '5px' }, },
    { id: 'requires', type: 'objectNode', data: { label: '<<requires>>' , backgroundColor: 'yellow',borderStyle : '1px solid black'}, position: { x: 10, y: 75 }, parentNode: 'constraints', extent: 'parent', style: { backgroundColor: 'yellow', width: 200, height: 100, border: '1px solid black', borderRadius: '5px' }, },
...
export const rfStackDispose = [
    { id: 'stack', type: 'input', data: { label: 's:stack' }, position: { x: 100, y: 100 }, className: 'light', style: { backgroundColor: 'rgba(255, 0, 0, 0.2)', width: 200, height: 100 }, },
    { id: 'stack-var', type: 'objectNode', data: { label: 'cnt=0' }, position: { x: 20, y: 50 }, parentNode: 'stack', extent: 'parent', },
    { id: 'nullpointer', type:'output', data: { label: '' }, position: { x: 250, y: 250 }, style: { width: 30, height: 30 }, },
    { id: 'nptr', type: 'circleNode', data: { label: '⏊' }, position: { x: 5, y: 5 }, parentNode: 'nullpointer', extent: 'parent', },
];